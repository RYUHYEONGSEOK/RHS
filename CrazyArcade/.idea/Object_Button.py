...
class Button:
    ...
    def enter(self):
        #버튼의 종류를 인식(1.시작버튼 2.맵선택1 3.맵선택2)
        if self.buttonType == 1:
            self.sizeX, self.sizeY = 192, 55
            self.buttonImage = load_image('..\\Sprite\\02.Lobby\\Lobby_Button_Start.bmp')
        elif self.buttonType == 2:
            self.sizeX, self.sizeY = 135, 21
            self.buttonImage = load_image('..\\Sprite\\02.Lobby\\Loddy_Image_SelectMap_0.bmp')
        elif self.buttonType == 3:
            self.sizeX, self.sizeY = 135, 21
            self.buttonImage = load_image('..\\Sprite\\02.Lobby\\Loddy_Image_SelectMap_1.bmp')
        elif self.buttonType == 4:
            self.sizeX, self.sizeY = 140, 32
            self.buttonImage = load_image('..\\Sprite\\03.InGame\\InGame_Button_Out.bmp')
